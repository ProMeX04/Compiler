...
interface TestPanelProps {
  testCases: TestCase[];
  onTestCaseChange: (index: number, field: keyof TestCase, value: string) => void;
  onAddTestCase: () => void;
...
export function TestPanel({ testCases, onTestCaseChange, onAddTestCase, onRemoveTestCase }: TestPanelProps) {
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  ...
                  {tc.passed !== undefined && (
                    <span className={`text-xs ${tc.passed ? 'text-green-500' : 'text-red-500'}`}>
